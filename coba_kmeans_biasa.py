...
from hw5.libs.common.util import int_to_tuple, save_to_csv, get_unique_list
...
if __name__ == '__main__':
    ...
    fig = plt.figure()
    plt.scatter(reduced_X_train[:, 0], reduced_X_train[:, 1], c=new_Y_train, s=150, cmap='inferno')
    plt.show()
