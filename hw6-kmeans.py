...
if __name__ == '__main__':
    ...
    save_to_csv('exec-kmeans.csv', exec_times, rot_path="hw6")
    save_to_csv('test-scores-kmeans.csv', test_scores, rot_path="hw6")
    save_to_csv('best-acc-kmeans.csv', stored_accuracy, rot_path="hw6")
